...
My current direction is SRE and platform engineering. I like the part after `git push`: failed migrations, stuck queues, cache behavior, release safety, useful alerts, and recovery steps that still make sense at 03:00.

```text
working set
  Go          SLOs, error budgets, burn-rate windows
  Linux       containers, networking, failure drills
  Cloud       AWS, Terraform, Kubernetes
  Operations  Prometheus, Grafana, Alertmanager, runbooks
```
...
I write at [lukagolubovic.com](https://lukagolubovic.com). I am also on [LinkedIn](https://www.linkedin.com/in/lukagolubovic/).

I am finishing a Software Engineering BSc at Metropolitan University Belgrade, expected 2027.

[chat]: https://github.com/golubovicluka/Distributed-chat-application
[inventory]: https://github.com/golubovicluka/IT355-cloud-resource-inventory
[architex]: https://github.com/golubovicluka/Architex
[commerce]: https://github.com/golubovicluka/e-Commerce
